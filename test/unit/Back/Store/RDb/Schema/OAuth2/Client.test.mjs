...
describe('Fl64_Gpt_User_Back_Store_RDb_Schema_OAuth2_Client', () => {
    ...
    it('should have the correct ENTITY name and primary key', async () => {
        assert.equal(rdbDto.getEntityName(), `${DEF.NAME}/fl64/gpt/oauth/client`, 'Entity name should match the expected path');
